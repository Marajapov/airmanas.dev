...
<div class="main-content container no-padding">
    <div class="row">
        <h2>QIWI – это удобный сервис для оплаты всех повседневных услуг</h2>
        QIWI номер:
        ...
        После пополнение, мы отправим PNR код на указанный вами почу. 
        <a href="http://qiwi.kg/001-2.html">Расположение платежных терминалов QIWI</a><br /><br />
        <a href="http://qiwi.kg/001-2.html">Как оплатить</a><br /><br />
        <!-- flight-info -->   
    </div>
    <br /><br />
    <hr/>
    <div class="row">
        <h2>Мобильник – это удобный сервис для оплаты всех повседневных услуг</h2>
        Мобильник номер:
        <div class="flight-info clearfix" style="background-color:#FF0000; color:#FFFFFF; font-size:xx-large; ">
        <span style="margin-left:25px;">{{ $paycode }}</span>
        </div>
        ...
        После пополнение, мы отправим PNR код на указанный вами почу. 
        <a href="https://www.mobilnik.kg/#/map">Расположение платежных терминалов QIWI</a><br /><br />
        <div class="flight-info clearfix" style="background-color:#FF0000; color:#FFFFFF; font-size:xx-large; ">
        <span style="margin-left:25px;">Время для оплаты: <span id="time"></span></span>
        </div>
